# Content Log — Never Repeat

Before posting ANYTHING, check this file. If the hook, angle, or insight has been used — pick a different one.
...
- "CTA is too vague / generic" (used on mysyntax.dev, trafficclaw)
- "no demo/example above the fold" (used on getrevloo)
- "navigation too complex" (used on gaming site)
