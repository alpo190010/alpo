 ...
 */
export const ACTIVE_DIMENSIONS: ReadonlySet<string> = new Set(["socialProof", "structuredData", "checkout", "pricing", "images", "title", "shipping", "description", "trust", "pageSpeed", "mobileCta", "crossSell", "variantUx", "sizeGuide", "aiDiscoverability", "accessibility"]);
