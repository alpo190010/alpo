  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onClick={onRetry}
        className="px-6 py-2.5 rounded-full text-sm font-bold text-white cursor-pointer primary-gradient hover:scale-[1.02] active:scale-95 transition-all polish-focus-ring"
      >
        Retry
      </button>
    </div>
